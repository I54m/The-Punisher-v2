...
class PunishmentTest {
    ...
    @Test
    void isPermanent() {
        Punishment punishment = new Punishment(0, Punishment.Type.ALL, "Custom", "N/A", ((long) 4.73e+11 + System.currentTimeMillis()), UUIDFetcher.getBLANK_UUID(), "N/A", UUIDFetcher.getBLANK_UUID(), "N/A", Punishment.Status.Active, null);
        assertTrue(punishment.isPermanent());
    }

    @Test
    void isRepBan() {
        Punishment ban = new Punishment(0, Punishment.Type.BAN, "Custom", "N/A", (long) 3.154e+12 + System.currentTimeMillis(), UUIDFetcher.getBLANK_UUID(), "N/A", UUIDFetcher.getBLANK_UUID(), "Overly Toxic (Rep dropped below -10)", Punishment.Status.Active, null);
    ...
    @Test
    void verify() {
        Punishment ban = new Punishment(0, Punishment.Type.BAN, "Custom", "N/A", null, UUIDFetcher.formatUUID("74f04a9bb7f9409da940b051f14dd3a5"), null, null, null, Punishment.Status.Active, null);
    ...
    @Test
    void setIssueDate() {
        Punishment punishment = new Punishment(0, Punishment.Type.ALL, "Custom", null, ((long) 4.73e+11 + System.currentTimeMillis()), UUIDFetcher.getBLANK_UUID(), "N/A", UUIDFetcher.getBLANK_UUID(), "N/A", Punishment.Status.Active, null);
    ...
    @Test
    void setStatus() {
        Punishment punishment = new Punishment(0, Punishment.Type.ALL, "Custom", null, ((long) 4.73e+11 + System.currentTimeMillis()), UUIDFetcher.getBLANK_UUID(), "N/A", UUIDFetcher.getBLANK_UUID(), "N/A", Punishment.Status.Pending, null);
