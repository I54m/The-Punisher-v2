...
public abstract class AbstractPacket extends DefinedPacket {
     ...
     * use the setCancelled(boolean cancelled) method of the {@link com.i54mpenguin.protocol.api.event.PacketReceiveEvent}
     * or {@link com.i54mpenguin.protocol.api.event.PacketSendEvent} instead.
     * @param cancelSend
     */
    @Deprecated
