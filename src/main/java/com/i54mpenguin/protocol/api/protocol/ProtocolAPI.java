package com.i54mpenguin.protocol.api.protocol;

import com.i54mpenguin.protocol.api.event.EventManager;
...
//    private static final TrafficManager TRAFFIC_MANAGER = new TrafficManager();
    ...
    /**
     * The event manager is used to register {@link com.i54mpenguin.protocol.api.handler.PacketListener}s
     * @see EventManager
     * @see com.i54mpenguin.protocol.api.handler.PacketListener
