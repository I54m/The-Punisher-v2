...
public final class ProtocolVersions {
    ...
    public static final int MINECRAFT_1_16_2 = 751;// https://wiki.vg/Pre-release_protocol https://wiki.vg/Protocol_version_numbers
    ...
    public static Map<String, Integer> getSupportedMajorVersions() {
        ...
        supportedVersions.put("1_16_2", MINECRAFT_1_16_2); // only minor version due to the piglin brute item that was added
        return supportedVersions;
    }
