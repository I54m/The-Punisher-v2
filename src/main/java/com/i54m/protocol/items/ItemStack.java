...
public final class ItemStack implements Cloneable {
    ...
    public static ItemStack read(final ByteBuf buf, final int protocolVersion) {
        ...
        try {
            ...
            PunisherPlugin.getInstance().getLogger().log(Level.SEVERE, "[Protocol] Exception occurred when reading ItemStack from buffer. Protocol version = " + protocolVersion, e);
        }
        return null;
    }
