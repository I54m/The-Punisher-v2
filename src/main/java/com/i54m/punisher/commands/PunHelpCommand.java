...
//            commandSender.sendMessage(new ComponentBuilder("/reputation <player> <plus|minus|set> <amount>").color(ChatColor.RED).append(": Change a player's reputation").color(ChatColor.WHITE).create());
        ...
        if (commandSender.hasPermission("punisher.staff.hide.others"))
            commandSender.sendMessage(new ComponentBuilder("/staffhide [player]").color(ChatColor.RED).append(": Hide or unhide yourself or others from the staff list").color(ChatColor.WHITE).create());
        else if (commandSender.hasPermission("punisher.staff.hide"))
            commandSender.sendMessage(new ComponentBuilder("/staffhide").color(ChatColor.RED).append(": Hide or unhide from the staff list").color(ChatColor.WHITE).create());
